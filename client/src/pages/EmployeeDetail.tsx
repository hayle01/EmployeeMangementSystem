...
export default function EmployeeDetail() {
  ...
  const { data: historyData } = useEmployeeHistory(id);
  ...
  if (!employee) {
    return <div className="py-12 text-center text-muted-foreground">Employee not found</div>;
  }
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardContent className="flex flex-col items-center p-6">
              ...
              <Badge
                ...
                className={`mt-2 ${isActive ? "bg-green-400 hover:bg-success/90" : "bg-red-400"}`}
              >
          ...
          <Card>
            ...
            <CardContent className="flex flex-col items-center">
              {employee.qrImageUrl ? (
                ...
                <p className="py-4 text-sm text-muted-foreground">QR code not yet generated</p>
              )}
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4 lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">{labels.employee.employmentInformation}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              {!historyData || historyData.history.length === 0 ? (
                <p className="text-sm text-muted-foreground">No previous history found.</p>
              ) : (
                <div className="space-y-4">
